---
name: dotnet-backend
description: "Build ASP.NET Core 8+ backend services with EF Core, auth and production API patterns."
risk: safe
source: self
